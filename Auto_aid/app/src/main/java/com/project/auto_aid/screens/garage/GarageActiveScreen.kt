...
fun GarageActiveScreen(
    ...
    fun addMessageIfMissing(
        list: SnapshotStateList<GarageChatUiMessage>,
        message: GarageChatUiMessage
    ) {
    ...
    fun openDialer(phone: String?) {
        ...
        if (cleanPhone.isBlank()) {
            error = "Provider phone number is missing"
            return
        }
            ...
            if (token.isNullOrBlank()) {
                ...
                try {
                    ...
                    s.on(Socket.EVENT_DISCONNECT) {
                        scope.launch { chatConnected = false }
                    }
